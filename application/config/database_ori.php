...
writeLog("[{$sLogFileId}] UnivCode=".json_encode($_POST['UnivCode']), $eLogPath, $bLogable);
...
//echo $DB_CONNECTION[$_POST['UnivCode']]['hostname'];
//exit;
...
//$db['default']['hostname'] = "0011601.cway.kr,8433";
//$db['default']['username'] = "dmk";
//$db['default']['password'] = "!@dmk8191";
...
writeLog("[{$sLogFileId}] hostname=".json_encode($db['default']['hostname']), $eLogPath, $bLogable);
